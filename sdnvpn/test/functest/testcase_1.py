...
def main():
    ...
    try:
        ...
        vm_2_ip = test_utils.get_instance_ip(cloud, vm_2)
        ...
        vm_3_ip = test_utils.get_instance_ip(cloud, vm_3)
        ...
        vm_5 = test_utils.create_instance(
            ...
            secgroup_name=TESTCASE_CONFIG.secgroup_name,
            compute_node=av_zone_2)
        vm_5_ip = test_utils.get_instance_ip(cloud, vm_5)
        ...
        vm_4 = test_utils.create_instance(
            ...
            compute_node=av_zone_1,
            userdata=u4)
        vm_4_ip = test_utils.get_instance_ip(cloud, vm_4)
