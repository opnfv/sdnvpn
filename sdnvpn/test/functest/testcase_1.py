...
def main():
    ...
    results.add_to_summary(0, "=")
    results.details['name'] = TESTCASE_CONFIG.description
    ...
    try:
        ...
        results.details['SN1_ping_test_1'] = ("%s can ping %s: %s",
                                              TESTCASE_CONFIG.instance_1_name,
                                              TESTCASE_CONFIG.instance_2_name,
                                              results.test_result)
        results.get_ping_status(vm_1, vm_3, expected="PASS", timeout=30)
        results.details['SN1_ping_test_2'] = ("%s can ping %s: %s",
                                              TESTCASE_CONFIG.instance_1_name,
                                              TESTCASE_CONFIG.instance_3_name,
                                              results.test_result)
        results.get_ping_status(vm_1, vm_4, expected="FAIL", timeout=30)
        results.details['SN1_ping_test_3'] = ("%s can not ping %s: %s",
                                              TESTCASE_CONFIG.instance_1_name,
                                              TESTCASE_CONFIG.instance_4_name,
                                              results.test_result)
        ...
        results.details['SN2_ping_test_1'] = ("%s can ping %s: %s",
                                              TESTCASE_CONFIG.instance_4_name,
                                              TESTCASE_CONFIG.instance_5_name,
                                              results.test_result)
        ...
        results.details['SN1_SN2_ping_test_1'] = ("%s can ping %s: %s",
                                                  TESTCASE_CONFIG.instance_1_name,
                                                  TESTCASE_CONFIG.instance_4_name,
                                                  results.test_result)
        results.get_ping_status(vm_1, vm_5, expected="PASS", timeout=30)
        results.details['SN1_SN2_ping_test_2'] = ("%s can ping %s: %s",
                                                  TESTCASE_CONFIG.instance_1_name,
                                                  TESTCASE_CONFIG.instance_5_name,
                                                  results.test_result)
