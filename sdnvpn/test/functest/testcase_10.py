...
def monitor(cloud, in_data, out_data, vm):
    ...
    while in_data["stop_thread"] is False:
        try:
            time.sleep(1)
            vm_console_out_lines = cloud.compute.\
...
def main():
    ...
    try:
        ...
        monitor_thread4 = Process(target=monitor, args=(cloud, monitor_input4,
                                                        monitor_output4,
                                                        vm_4,))
