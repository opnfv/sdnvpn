...
def main():
    ...
    try:
        ...
        network_1_id = test_utils.create_net(cloud,
                                             TESTCASE_CONFIG.net_1_name)
        subnet_1_id = test_utils.create_subnet(cloud,
...
def record_test_result(expected_flow_count, actual_flow_count,
    ...
    msg = ("OVS flows are programmed after resync expected flow count %s,"
    ...
    msg = ("OVS groups are programmed after resync expected group count %s,"
           " actual group count %s" % (str(expected_group_count),
                                       str(actual_group_count)))
    results.add_to_summary(0, "-")
