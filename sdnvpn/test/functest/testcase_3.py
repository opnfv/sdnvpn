...
def main():
    ...
    for obj in controller_nodes:
       ...
       cmd_start_quagga = '/opt/opendaylight/bin/client "odl:configure-bgp -op start-bgp-server --as-num 100 --router-id {0}"'.format(controller_ip)


       output_start_quagga = obj.run_cmd(cmd_start_quagga)
