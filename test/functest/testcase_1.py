...
def main():
    ...
    # boot INTANCES
    create_instance(
        nova_client, INSTANCE_1_NAME, FLAVOR, image_id, network_1_id, sg_id)
    create_instance(
        nova_client, INSTANCE_2_NAME, FLAVOR, image_id, network_1_id, sg_id)
    create_instance(
        nova_client, INSTANCE_3_NAME, FLAVOR, image_id, network_1_id, sg_id)
    create_instance(
        nova_client, INSTANCE_4_NAME, FLAVOR, image_id, network_2_id, sg_id)
    create_instance(
        nova_client, INSTANCE_5_NAME, FLAVOR, image_id, network_2_id, sg_id)
