...
logger = ft_logger.Logger("sdnvpn-testcase-5").getLogger()
...
ROUTE_DISTINGUISHERS1 = ft_utils.get_parameter_from_yaml(
    "testcases.testcase_5.route_distinguishers1", config_file)
ROUTE_DISTINGUISHERS2 = ft_utils.get_parameter_from_yaml(
    "testcases.testcase_5.route_distinguishers2", config_file)
...
def main():
    ...
    kwargs = {
        ...
        "route_distinguishers": ROUTE_DISTINGUISHERS1,
        "name": vpn1_name
    }
    ...
    kwargs = {
        ...
        "route_distinguishers": ROUTE_DISTINGUISHERS2,
        "name": vpn2_name
    }
    ...
    results.check_ssh_output(
        vm_4, vm_4_ip, vm_5, vm_5_ip, expected=INSTANCE_5_NAME, timeout=200)
