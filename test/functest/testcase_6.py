...
"""
    ...
    Test setup procedure:
      - Set up VM1 on Node1 and VM3 on Node2, both having ports in
        the same Neutron Network N1 and having 10.10.10/24 addresses in
        subnet SN1.
      - Set up VM2 on Node1 having ports in Neutron Network N3 and having
        10.10.12/24 addresses in subnet SN3
      - Set up VM4 on Node1 and VM5 on Node2, both having ports in Neutron
        ...
        N2/SN2 are connected to router R2.
