...
NET_3_NAME = ft_utils.get_parameter_from_yaml(
    "testcases.testcase_6.net_3_name", config_file)
SUBNET_3_NAME = ft_utils.get_parameter_from_yaml(
    "testcases.testcase_6.subnet_3_name", config_file)
SUBNET_3_CIDR = ft_utils.get_parameter_from_yaml(
    "testcases.testcase_6.subnet_3_cidr", config_file)
...
ROUTE_DISTINGUISHERS_1 = ft_utils.get_parameter_from_yaml(
    "testcases.testcase_6.route_distinguishers1", config_file)
ROUTE_DISTINGUISHERS_2 = ft_utils.get_parameter_from_yaml(
    "testcases.testcase_6.route_distinguishers2", config_file)
...
def main():
    ...
    network_1_id = test_utils.create_net(neutron_client, NET_1_NAME)
    ...
    network_3_id = test_utils.create_net(neutron_client, NET_3_NAME)
    test_utils.create_subnet(neutron_client,
                             SUBNET_3_NAME,
                             SUBNET_3_CIDR,
                             network_3_id)
    ...
    kwargs = {
        "import_targets": TARGETS_1,
        "export_targets": TARGETS_1,
        "route_distinguishers": ROUTE_DISTINGUISHERS_1,
        "name": vpn_1_name
    }
    ...
    msg = ("Associate network '%s' to the VPN." % NET_3_NAME)
    logger.info(msg)
    results.add_to_summary(1, msg)
    results.add_to_summary(0, "-")
    ...
    kwargs = {
        "import_targets": TARGETS_2,
        "export_targets": TARGETS_2,
        "route_distinguishers": ROUTE_DISTINGUISHERS_2,
        "name": vpn_2_name
    }
    ...
    msg = ("Associate router '%s' to the VPN." % ROUTER_2_NAME)
    logger.info(msg)
    results.add_to_summary(0, "-")
    results.add_to_summary(1, msg)
    results.add_to_summary(0, "-")
    ...
    results.add_to_summary(0, "-")
    kwargs = {
        "import_targets": [TARGETS_1, TARGETS_2],
        "export_targets": TARGETS_1,
        "name": vpn_1_name
    }
    bgpvpn_1 = os_utils.update_bgpvpn(neutron_client, bgpvpn_1_id, **kwargs)
