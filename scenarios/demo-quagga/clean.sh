...
ovs-vsctl del-port br-phy br-vxlan
ovs-vsctl del-br br-phy

/etc/init.d/openvswitch-switch stop

ifconfig br-vxlan 172.29.240.10 netmask 255.255.252.0

dpkg -r openvswitch-switch
dpkg --purge openvswitch-switch
echo "Info: OVS configuration is cleaned up successfully"

echo "Info: Delete the network and namespace configuation"
echo "-----------------------------------------------------------------------"
ip netns delete n1
echo "Info: Deleted the network and namespace configuation"
